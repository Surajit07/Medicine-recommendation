...
def helper(dis):
    # """Retrieve description, precautions, medications, diets, and workouts for a given disease"""
...
def get_predicted_value(patient_symptoms):
    ...
    for item in patient_symptoms:
        input_vector[symptoms_dict.get(item, -1)] = 1  # Default to -1 if symptom not found
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173"],  #connecting with frontend
